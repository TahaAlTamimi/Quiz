...
=>"you need more exp"
*/
function isMyAgeAndExpEnough(age,experince){
	if(age>=25 && age<30 && experince>5)
	{
return "you are awesome";
	}
	else if(age>=30 && experince>5){
		return "you are good";

	}
	else if (age>=25 && experince<5 && experince>2){
		return "don't worry need to work on your self more"
